...
<?php
    ...
    if(isset($_POST['reset_pass'])){
        ...
        $user= $_SESSION['admin'];
        $sql_req="SELECT * FROM `admin` WHERE Admin_email='$user';";
            ...
            while($row=mysqli_fetch_assoc($result)){
                if($row['Password'] != md5($old)){
                    ...
                    if($new != $cnew){
                        ...
                        $new=md5($new);
                        $sql="UPDATE `admin` SET `Password`='$new',`Modified_Time`=CURRENT_TIMESTAMP() WHERE `Admin_email`='$user';";
                        ...
                        if(!$result2){
                            ...
                            echo "if(confirm('Password Changed')){";
                                echo "window.location.href='Admin-Profile.php'";
                            echo "}";
                        }
                    }
                }
