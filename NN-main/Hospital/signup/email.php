  ...
  $(function() {
    ...
    if (isset($_POST['email_send'])) {
      if (isset($_POST['mail'])) {
        ...
        $sql = "(SELECT hos_email FROM hospital WHERE hos_email = '$md_email')";
        ...
        if (mysqli_num_rows($result) != 0) {
          ...
          $body = "Thank You For Enrolling in Neighbouring Nurse.\nThis is your verification code $no \n Please fill This code to verify your hospital MailId.  ";
          $headers = "From: ht1872004@gmail.com";

          $_SESSION['no'] = $no;
          $_SESSION['user']['email'] = $md_email;

          if (mail($md_email, $subject, $body, $headers)) {
            echo "$('#verify').show();
                      $('#sendmail').hide();
                      console.log(
                       ";
