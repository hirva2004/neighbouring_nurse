                ...
                try {
                    if ($r) {
                        ...
                        if ($a) {
                            ...
                            $body = "Click on this link to set new Password <br><a href='http://localhost/Project/NN/Admin/login/forgot_password.php?email=$u'>forgot password</a>";
